    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="孩子ID">
              <a-input placeholder="请输入孩子ID" v-model="queryParam.chId"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
        ...
        <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="科目名称">
              <a-input placeholder="请输入科目名称" v-model="queryParam.kmName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="模式名称">
              <a-input placeholder="请输入模式名称" v-model="queryParam.msName"></a-input>
            </a-form-item>
          </a-col>
        </template>
          <a-col :md="6" :sm="8" >
    ...
    data () {
      return {
		...
		url: {
          ...
          exportXlsUrl: "kc/kc/exportXls",
          importExcelUrl: "kc/kc/importExcel",
       },
    }
  },
  computed: {
