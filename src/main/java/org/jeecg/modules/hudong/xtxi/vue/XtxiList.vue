    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="系统推送时间">
              <a-input placeholder="请输入系统推送时间" v-model="queryParam.psTime"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
        ...
        <a-col :md="6" :sm="8">
            <a-form-item label="消息简介">
              <a-input placeholder="请输入消息简介" v-model="queryParam.introduce"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
